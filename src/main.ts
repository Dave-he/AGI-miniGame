...
async function bootstrap(): Promise<void> {
    ...
    const app = new App({ canvas, hudRoot, progressionRoot: progRoot, economyRoot: econRoot, epochRoot, tutorialRoot: tutorialRoot ?? undefined, statsRoot: statsRoot ?? undefined, godRoot: godRoot ?? undefined, vaultRoot: undefined });
